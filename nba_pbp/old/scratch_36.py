"""finalizing the new subs_df function which will include the resulting FT in the subs_stint"""
"""maybe need to check the gamestints function after"""

def get_subs2(pbp2_df):
    ...
    subs_df.insert(3, 'subs_stint_bool', subs_df.PCTIMESTRING == subs_df.PCTIMESTRING.shift())
    subs_df.insert(3, 'subs_stint', subs_df['subs_stint_bool'].eq(False).cumsum())

    return subs_df

# you do need to change the gamestints function, and that means maybe just redoing the whole thing
